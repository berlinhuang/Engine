...
void TcpClient::connect()
{
    ...
    LOG_INFO << "TcpClient::connect[" << name_
             << "] - connecting to "  << connector_->serverAddress().toIpPort();
    connect_ = true;
    connector_->start();
}
...
void TcpClient::newConnection(int sockfd)
{
    ...
    conn->setConnectionCallback(connectionCallback_);// ClientServer::onConnection()
    conn->setMessageCallback(messageCallback_);// ClientServer::onMessage()
