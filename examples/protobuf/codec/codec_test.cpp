...
void testQuery()
{
    ...
    boost::shared_ptr<Engine::Query> newQuery = down_pointer_cast<Engine::Query>(message);
...
void testAnswer()
{
    ...
    boost::shared_ptr<Engine::Answer> newAnswer = down_pointer_cast<Engine::Answer>(message);
